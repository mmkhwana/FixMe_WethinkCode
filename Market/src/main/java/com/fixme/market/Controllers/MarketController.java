...
public class MarketController
{
    ...
    public void ProcessBuy(int brokerId, String instrType_, int quantity_, int price_) throws IOException
    {
        if (this.db.buyInstrument(instrType_, quantity_, price_)){
            printWriter.println(processFIXMessage(populateFIX("Accepted Your request", brokerId)));
        }
        else {
            printWriter.println(processFIXMessage(populateFIX("Rejected your Request", brokerId)));
        }
    }
